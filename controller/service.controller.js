...
const createService = async (req, res) => {
  try {
    const vehicleTypesDefault = ['BIKE', 'CAR', 'AUTO', 'TRUCK'];
    const { name, description, categoryId, basePrice, estimatedTime, icon, vehicleTypes } = req.body;
...
const updateService = async (req, res) => {
  try {
    const { id } = req.params;
    const { name, description, categoryId, basePrice, estimatedTime, icon, status, vehicleTypes } = req.body;
