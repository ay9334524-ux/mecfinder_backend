...
const mechanicSchema = new mongoose.Schema({
  ...
  // Acceptance rate tracking (for matching scoring)
  totalOffersReceived: { type: Number, default: 0 },
  ...
  // Track if mechanic owes money to the company (cannot accept rides if true)
  hasActiveDebt: {
    type: Boolean,
    default: false,
  },
...
mechanicSchema.index({ status: 1, isOnline: 1, isBusy: 1, hasActiveDebt: 1 }); // Compound for mechanic search
