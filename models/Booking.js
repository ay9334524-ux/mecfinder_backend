...
const bookingSchema = new mongoose.Schema({
  ...
  // Mechanics who have already had a shot at this booking (rejected or
  // timed out). Used by re-search to avoid re-offering the same job to a
  // mechanic who already declined it.
  excludedMechanicIds: [{
    type: mongoose.Schema.Types.ObjectId,
    ref: 'Mechanic',
  }],
