...
module.exports = {
  apps: [{
    ...
    // Single instance — Socket.io polling handshake breaks across PM2 cluster
    // workers (no sticky sessions). Stay on fork mode until we add
    // @socket.io/sticky or front sticky-LB.
    instances: 1,
    exec_mode: 'fork',
