...
const { validate, helpValidations } = require('../utils/validation');
...
router.post('/faq/:id/helpful', validate(helpValidations.faqHelpful), helpController.markFAQHelpful);
...
protectedRouter.post('/ticket', validate(helpValidations.createTicket), helpController.createTicket);
protectedRouter.get('/tickets', helpController.getMyTickets);
protectedRouter.get('/ticket/:id', helpController.getTicketDetails);
protectedRouter.post('/ticket/:id/reply', validate(helpValidations.ticketReply), helpController.addTicketReply);
